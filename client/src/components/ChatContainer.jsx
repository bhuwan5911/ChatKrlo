...
const ChatContainer = () => {
    ...
    // 🔥 REAL-TIME MESSAGE LISTENER (Correct Working)
    useEffect(() => {
        if (!socket) return;
        ...
        const handleNewMessage = (newMessage) => {
            ...
            const incomingReceiverId = String(newMessage.receiverId);

            const currentChatId = String(selectedUser._id);
            const myId = String(authUser._id);

            const isForThisChat =
                incomingSenderId === currentChatId || incomingReceiverId === myId;
